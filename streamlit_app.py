    ...
    if query:
        ...
        if use_llm:
            ...
            <div style="background: #eaf2f8; border: 1px solid #aed6f1; border-radius: 12px;
                        padding: 20px; margin: 16px 0; color: #1a1a2e;">
                {answer}
            </div>
            <style>
                div[style*="eaf2f8"] h1, div[style*="eaf2f8"] h2, div[style*="eaf2f8"] h3,
                div[style*="eaf2f8"] h4, div[style*="eaf2f8"] h5, div[style*="eaf2f8"] h6 {{
                    color: #1a5276 !important;
                }}
                div[style*="eaf2f8"] li, div[style*="eaf2f8"] p, div[style*="eaf2f8"] span,
                div[style*="eaf2f8"] strong, div[style*="eaf2f8"] em {{
